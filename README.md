...
### Dataframe Structure
f1-vis can produce multiple visualizations at once by inputting each as a separate row in the .csv or dataframe. Example below and included as a sample .csv:
